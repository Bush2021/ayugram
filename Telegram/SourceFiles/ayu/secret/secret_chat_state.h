...
[[nodiscard]] QByteArray SerializeChatStates(
	const std::vector<ChatState> &states);
[[nodiscard]] std::vector<ChatState> DeserializeChatStates(
...
[[nodiscard]] QByteArray SerializeHistory(
	const std::vector<HistoryRecord> &records);
[[nodiscard]] std::vector<HistoryRecord> DeserializeHistory(
	const QByteArray &serialized);
